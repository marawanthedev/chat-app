...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="flex justify-center items-center min-h-screen">
      ...
      >
        <div className="p-4 rounded-lg shadow-lg overflow-hidden h-full">
          {children}
        </div>
      </div>
      ...
      <div className="hidden sm:block lg:block xl:block w-full max-w-[414px] sm:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1280px] h-full p-4 rounded-lg shadow-lg overflow-hidden">
